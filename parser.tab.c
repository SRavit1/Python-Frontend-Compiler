...
{
  "$end", "error", "$undefined", "DEF", "RET", "EQUAL", "OPEN_PAREN",
  "CLOSE_PAREN", "COMMA", "COLON", "TAB", "IDENTIFIER", "INT_TOKEN",
  "FLOAT_TOKEN", "STRING_TOKEN", "BOOL_TOKEN", "OP", "\"\\n\"", "$accept",
  "statement_list", "top_statement", "statement", "assignment",
...
{
       5,    -9,    18,    30,     5,     3,   -36,   -36,   -36,   -36,
     -36,   -36,     7,    18,    15,   -36,   -36,   -36,   -36,   -36,
       9,   -36,   -36,    18,    18,   -36,   -36,   -36,    12,    10,
      18,     9,    31,     9,    28,   -36,    33,   -36,     9,   -36,
      18,    34,    37,    36,     9,    23,    39,    34,   -36,   -36,
      23,    39,   -36
};
...
{
       0,     0,     0,     0,     0,     0,     2,     4,     7,     8,
       9,     5,     0,     0,    30,    25,    26,    27,    28,    24,
      14,    22,    23,     0,     0,     6,     1,     3,     0,     0,
       0,    10,     0,    12,     0,    17,     0,    21,    29,    11,
       0,     0,     0,     0,    13,     0,    15,     0,    18,    19,
       0,    16,    20
};
...
{
       9,    29,    12,    26,     9,     9,     1,     2,     1,     2,
      49,    31,    33,    28,     3,    52,     3,    37,    38,    34,
       4,    24,     4,    35,    13,    30,    30,     2,    44,    14,
      15,    16,    17,    18,     3,    23,    24,    41,    39,    40,
      42,    43,    25,    27,    45,     9,    47,    48,    51,    50,
       9
};

static const yytype_uint8 yycheck[] =
{
       0,    13,    11,     0,     4,     5,     3,     4,     3,     4,
      45,    23,    24,     6,    11,    50,    11,     7,    30,     7,
      17,     6,    17,    11,     6,    16,    16,     4,    40,    11,
      12,    13,    14,    15,    11,     5,     6,     9,     7,     8,
       7,     8,     4,     5,    10,    45,     9,    11,    47,    10,
      50
};
...
{
       0,     3,     4,    11,    17,    19,    20,    21,    22,    23,
      25,    26,    11,     6,    11,    12,    13,    14,    15,    23,
      29,    30,    31,     5,     6,    20,     0,    20,     6,    29,
      16,    29,    24,    29,     7,    11,    27,     7,    29,     7,
       8,     9,     7,     8,    29,    10,    28,     9,    11,    21,
      10,    28,    21
};
